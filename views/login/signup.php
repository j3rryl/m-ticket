...
<head>
    ...
    <link rel="stylesheet" href="/m-tickets/assets/css/signup.css">
...
<body>
    <div class="signup-container">
        <form class="form-container" method="POST">
            ...
            <a class="sign-in" href="/m-tickets/views/login/login.php">Sign In?</a>
            <br /><br />

        </form>
    </div>
</body>
<script src="/m-tickets/assets/js/login/pchecker.js"></script>
<script src="/m-tickets/assets/js/login/logins.js"></script>
