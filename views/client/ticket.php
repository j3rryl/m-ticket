...
?>
<link rel="stylesheet" href="/m-tickets/assets/css/ticket.css">
<!-- JavaScript -->
...
<div class="ticket-container">
    ...
    <div class="ticket-description">
        <div class="image-container">
            <img src=<?php echo '/m-tickets/assets/images/events/'.$event['event_image_url'] ?> alt="">
        </div>
...
<script src="/m-tickets/assets/js/client/ticket.js"></script>
<?php
