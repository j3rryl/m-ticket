...
<link rel="stylesheet" href="/m-tickets/assets/css/weekend.css">
    ...
    <div class="filter-container">
     ...
     foreach ($weekends as $weekend) {
        ...
        <div class="image-container">
            <?php
                echo '<img src="/m-tickets/assets/images/events/'.$weekend['event_image_url'].'"'.' alt="">';
...
<script src="/m-tickets/assets/js/client/weekend.js"></script>
<?php
