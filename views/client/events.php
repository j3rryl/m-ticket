...
?>
<link rel="stylesheet" href="/m-tickets/assets/css/events.css">
<title>Events</title>
    ...
    <div class="filter-container">
     ...
     foreach ($events as $event) {
        ...
        <div class="image-container">
            <?php
                echo '<img src="/m-tickets/assets/images/events/'.$event['event_image_url'].'"'.' alt="">';
    ...
    <div class="db-pagination">
        <ul class="pagination-list">
            ...
            for ($btn=1;$btn<=$total_pages;$btn++) {
                echo '<li class="page-number"><a class="page-number" id="'.$btn.'" href="/m-tickets/views/client/events.php?page='.$btn.'">'.$btn.'</a></li>';
            }
            ?>
        </ul>
    </div>
</div>
<script src="/m-tickets/assets/js/client/events.js"></script>
